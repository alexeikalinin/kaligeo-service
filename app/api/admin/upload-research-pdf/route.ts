/**
 * One-time route to generate & upload research PDF to Vercel Blob.
 * Protected by INTERNAL_SECRET. Delete after use.
 * GET /api/admin/upload-research-pdf?secret=<INTERNAL_SECRET>
 */
