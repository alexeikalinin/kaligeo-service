...
const QUERY_RESULTS = [
  { id:"q1", platform:"CHATGPT",    query:"Какую бухгалтерию выбрать для ИП на УСН?",         response:"Для ИП на УСН я рекомендую рассмотреть несколько популярных решений. Моё дело — один из самых популярных сервисов для малого бизнеса, предлагает автоматизацию отчётности и интеграцию с банками. Контур.Бухгалтерия подойдёт тем, кто работает с несколькими системами налогообложения. Для небольших ИП без сотрудников часто достаточно СберБухгалтерии.", brandMentioned:false, sentiment:"absent" },
  { id:"q2", platform:"PERPLEXITY", query:"Стоимость бухгалтерского обслуживания малого бизнеса", response:"Стоимость бухгалтерского обслуживания варьируется от 3 000 до 30 000 рублей в месяц. Онлайн-сервисы (Моё дело, Контур.Бухгалтерия) обходятся в 2 000–8 000 руб/мес. Аутсорсинговые компании берут 5 000–25 000 руб в зависимости от объёма операций.", brandMentioned:false, sentiment:"absent", sources:["https://www.klerk.ru/buh/articles/bukhgalterskoe-obsluzhivanie/","https://moe-delo.com/ceny/","https://kontur.ru/buhgalteriya/ceny"] },
  { id:"q3", platform:"YANDEXGPT",  query:"Бухгалтер на аутсорсе или штатный — что выгоднее?", response:"Аутсорсинг бухгалтерии обычно выгоднее для малого бизнеса. Штатный бухгалтер обходится от 60 000 руб/мес. Аутсорсинг — от 5 000 до 20 000 руб/мес. Компании 1С:БухОбслуживание и Финолог предлагают комплексное ведение за фиксированную плату.", brandMentioned:false, sentiment:"absent" },
  { id:"q4", platform:"CLAUDE",     query:"Как не получить штраф от налоговой малому бизнесу?", response:"Основные риски штрафов: несвоевременная сдача отчётности, ошибки в расчёте налогов. Сервисы Моё дело и Контур.Бухгалтерия имеют встроенные календари налоговых событий.", brandMentioned:false, sentiment:"absent" },
]
